    ...
    <table class="header2">
        <tr>
            <td class='header_billing' colspan='2'>
                ...
                <div class="underline bold">{{ $customerName }}</div>
                <div class="underline">{{ $customerAddress1 }},</div>
                <div class="underline">{{ $customerAddress2 }},</div>
                <div class="underline">{{ $customerAddress3 }}.</div>
            </td>
            <td class='header_info'>
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="header_info_data">{{ $invoiceNo }}</div>
                            <div class="header_info_data">{{ $poNo }}</div>
                            <div class="header_info_data">{{ $date }}</div>
                            <div class="header_info_data">{{ $due }}&nbsp;Days</div>
                        ...
                        <table class="total">
                            <tr>
                                ...
                                <td class=" boxTotal1">
                                    <div class="fcontainer2">
                                        <div class="fleft aleft">RM</div>
                                        <div class="fright aright">{{ $subtotal }}</div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class=" boxTotal2">
                                    <div class="fcontainer2">
                                        ...
                                        <div class="fright aright bold">{{ $grandTotal }}</div>
                                    </div>
                                </td>
                            </tr>
                        </table>
